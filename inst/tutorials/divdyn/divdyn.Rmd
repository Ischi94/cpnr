...
```{r change-level, exercise=TRUE, exercise.eval=FALSE, exercise.setup = "coral-setup"}
bs_fam <- binstat(
  x = corals,
  tax = "genus",
  bin = "stg",
...
```{r change-level-solution, exercise.setup = "coral-setup"}
bs_fam <- binstat(
  x = corals,
  tax = "family",
  bin = "stg",
...
```{r modify-plot, exercise=TRUE, exercise.eval=FALSE, exercise.setup = "coral-setup"}
tsplot(
  stages,
  boxes = "sys",
  boxes.col = "systemCol",
...
```{r modify-plot-solution, exercise.setup = "coral-setup"}
tsplot(
  stages,
  boxes = "sys",
  boxes.col = "systemCol",
...
```{r modify-plot2, exercise=TRUE, exercise.eval=FALSE, exercise.setup = "coral-setup"}
tsplot(
  stages,
  boxes = "sys",
  boxes.col = "systemCol",
...
```{r modify-plot2-solution, exercise.setup = "coral-setup"}
tsplot(
  stages,
  boxes = "sys",
  boxes.col = "systemCol",
